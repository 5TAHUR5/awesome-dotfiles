...
local create_shift_btn = function(args)
    ...
    ret_shifting_btn:buttons {
        awful.button({}, 1, function() inc_layout(1) end),
        awful.button({}, 3, function() inc_layout(-1) end),
        awful.button({}, 4, function() inc_layout(1) end),
        awful.button({}, 5, function() inc_layout(-1) end),
    }
...
local setting_shift_titlebars = create_setting_wrapper({
    ...
    setting_btn = create_shift_btn({
        ...
        shift_list = {
            {create_shift_text_icon("󰢦 ", "Top"), function() reset_titlebars(1, "top") end},
            {create_shift_text_icon("󰢥 ", "Right"), function() reset_titlebars(2, "right") end},
            {create_shift_text_icon("󰢢 ", "Bottom"), function() reset_titlebars(3, "bottom") end},
            {create_shift_text_icon("󰢣 ", "Left"), function() reset_titlebars(4, "left") end},
        },
        autostart = false
    }),
})
...
local set_rofi_style = function(style)
    ...
    awful.spawn.easy_async_with_shell([[sed -i -e "s/type[0-9]*/type]] .. style .. [[/g"  ~/.config/awesome/other/rofi/configs/launcher.rasi]])
end
...
local setting_shift_rofi_style = create_setting_wrapper({
    ...
    setting_btn = create_shift_btn({
        ...
        shift_list = {
            {create_shift_text_icon("󰎦 ", "Minimal"), function() set_rofi_style(1) end},
            {create_shift_text_icon("󰎩 ", "Minimal with icon"), function() set_rofi_style(2) end},
            {create_shift_text_icon("󰎬 ", "Middle"), function() set_rofi_style(3) end},
            {create_shift_text_icon("󰎮 ", "Fullscreen"), function() set_rofi_style(4) end},
        },
        autostart = false
    }),
})
...
local setting_shift_layouts = create_setting_wrapper({
    ...
    setting_btn = create_shift_btn({
        ...
        shift_list = {
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "floating.png", "Floating"), function() set_layout(awful.layout.suit.floating, 1) end},
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "tile.png", "Tile right"), function() set_layout(awful.layout.suit.tile, 2) end},
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "tileleft.png", "Tile left"), function() set_layout(awful.layout.suit.tile.left, 3) end},
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "tilebottom.png", "Tile bottom"), function() set_layout(awful.layout.suit.tile.bottom, 4) end},
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "tiletop.png", "Tile top"), function() set_layout(awful.layout.suit.tile.top, 5) end},
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "fairv.png", "Fair vertical"), function() set_layout(awful.layout.suit.fair, 6) end},
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "fairh.png", "Fair horizontal"), function() set_layout(awful.layout.suit.fair.horizontal, 7) end},
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "spiral.png", "Spiral"), function() set_layout(awful.layout.suit.spiral, 8) end},
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "dwindle.png", "Dwindle"), function() set_layout(awful.layout.suit.spiral.dwindle, 9) end},
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "max.png", "Max"), function() set_layout(awful.layout.suit.max, 10) end},
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "fullscreen.png", "Fullscreen"), function() set_layout(awful.layout.suit.max.fullscreen, 11) end},
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "magnifier.png", "Magnifier"), function() set_layout(awful.layout.suit.magnifier, 12) end},
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "cornernw.png", "Corner north west"), function() set_layout(awful.layout.suit.corner.nw, 13) end},
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "cornerne.png", "Corner north east"), function() set_layout(awful.layout.suit.corner.ne, 14) end},
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "cornersw.png", "Corner south west"), function() set_layout(awful.layout.suit.corner.sw, 15) end},
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "cornerse.png", "Corner south east"), function() set_layout(awful.layout.suit.corner.se, 16) end},
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "centered.png", "Centered"), function() set_layout(bling.layout.centered, 17) end},
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "vertical.png", "Vertical"), function() set_layout(bling.layout.vertical, 18) end},
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "horizontal.png", "Horizontal"), function() set_layout(bling.layout.horizontal, 19) end},
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "equalarea.png", "Equalarea"), function() set_layout(bling.layout.equalarea, 20) end},
            {create_shift_image_icon(paths.to_dir_theme_layouts_icons .. "deck.png", "Deck"), function() set_layout(bling.layout.deck, 21) end},            
        },
        autostart = true
    })
})
