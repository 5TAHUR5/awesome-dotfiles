...
screen.connect_signal("request::desktop_decoration", function(s)
	...
	local create_arcchart_widget = function(widget, signal, bg, fg, text, image, measurement_icon, max_value_state)
	...
	local resourses = wibox.widget({
		...
		spacing = 10,
		create_arcchart_widget(
			cpu,
			"cpu_forctr::update",
			beautiful.background_urgent,
			beautiful.red,
			"CPU:",
			gears.color.recolor_image(beautiful.icon_control_processor, beautiful.foreground),
			"%"
		),
		create_arcchart_widget(
			ram,
			...
			beautiful.green,
			"RAM:",
			gears.color.recolor_image(beautiful.icon_control_memory, beautiful.foreground),
			"%"
		),
		create_arcchart_widget(
			disk,
			...
			beautiful.blue,
			"DISK:",
			gears.color.recolor_image(beautiful.icon_control_hdd, beautiful.foreground),
			"%"
		),
		create_arcchart_widget(
			cputemp,
			...
			beautiful.orange,
			"TEMP:",
			gears.color.recolor_image(beautiful.icon_control_temperature, beautiful.foreground),
			"t°"
		),
	})
	...
	local create_tool_box = function(image)
		return wibox.widget({
			widget = wibox.container.background,
			bg = beautiful.background_alt,
	...
	local theme_launcher_tool_boxes = {
		["settings"] = create_tool_box(gears.color.recolor_image(beautiful.icon_control_settings, beautiful.foreground)),
		["walls"] = create_tool_box(gears.color.recolor_image(beautiful.icon_control_image, beautiful.foreground)),
		["color_schemes"] = create_tool_box(gears.color.recolor_image(beautiful.icon_control_pallete, beautiful.foreground)),
		["alacritty_themes"] = create_tool_box(gears.color.recolor_image(beautiful.icon_control_terminal, beautiful.foreground)),
	}

	for switch, box in pairs(theme_launcher_tool_boxes) do
		box:buttons({ awful.button({}, 1, function()
			awesome.emit_signal("summon::theme_changer", switch)
		end) })
	end
		...
		forced_width = dpi(75),
		{
			...
			halign = "center",
			{
				...
				margins = dpi(15),
				{
					id = "image",
					widget = wibox.widget.imagebox,
					image = gears.color.recolor_image(beautiful.icon_control_internet, beautiful.foreground),
					halign = "center",
					valign = "center",
					resize = true
				}
	...
	netbtn:connect_signal("mouse::enter", function()
		netbtn:get_children_by_id("image")[1].image = gears.color.recolor_image(beautiful.icon_control_internet, beautiful.gray)
	end)
	netbtn:connect_signal("mouse::leave", function()
		netbtn:get_children_by_id("image")[1].image = gears.color.recolor_image(beautiful.icon_control_internet, beautiful.foreground)
	end)

	netbtn:buttons({
		awful.button({}, 1, function()
			awesome.emit_signal("summon::wifi_popup")
			netbtn:get_children_by_id("image")[1].image = gears.color.recolor_image(beautiful.icon_control_internet, beautiful.background)
			gears.timer({
					...
					netspeed,
					{
						...
						expand = "outside",
						{
							...
							forced_width = dpi(15),
							{
								...
								halign = "right",
								valign = "center",
								image = gears.color.recolor_image(beautiful.icon_control_upload, beautiful.foreground),
							}
						...
						{ widget = wibox.container.background },
						{
							...
							forced_width = dpi(15),
							{
								...
								halign = "right",
								valign = "center",
								image = gears.color.recolor_image(beautiful.icon_control_download, beautiful.foreground),
							}
	...
	local create_music_button = function(image)
		return wibox.widget({
			widget = wibox.container.background,
			bg = beautiful.background_urgent,
			forced_width = dpi(37),
	...
	local next = create_music_button(gears.color.recolor_image(beautiful.icon_control_next, beautiful.foreground))
	next:buttons({
		awful.button({}, 1, function()
			playerctl:next()
		end),
	...
	local prev = create_music_button(gears.color.recolor_image(beautiful.icon_control_previous, beautiful.foreground))
	prev:buttons({
		awful.button({}, 1, function()
			playerctl:previous()
		end),
	...
	local music_button = create_music_button(gears.color.recolor_image(beautiful.icon_control_play, beautiful.foreground))
	...
	playerctl:connect_signal("playback_status", function(_, playing)
		if playing == true then
			music_button:get_children_by_id("icon")[1].image = gears.color.recolor_image(beautiful.icon_control_pause, beautiful.foreground)
		else
			music_button:get_children_by_id("icon")[1].image = gears.color.recolor_image(beautiful.icon_control_play, beautiful.foreground)
		end
	end)
	...
	local minus_position = create_music_button(gears.color.recolor_image(beautiful.icon_control_left, beautiful.foreground))
	...
	local plus_position = create_music_button(gears.color.recolor_image(beautiful.icon_control_right, beautiful.foreground))
	...
	awesome.connect_signal("player::set_position", function(value)
		if internal_update and value ~= previous_value then
	...
	state_switch:buttons({
		...
		awful.button({}, 5, function()
			awesome.emit_signal("crutch_top::set_state", "RAM")
		end),
	})
	...
	local create_process_line = function(i)
		...
		local kill = wibox.widget({
			...
			forced_width = dpi(22),
			{
				...
				{
					widget = wibox.widget.imagebox,
					image = gears.color.recolor_image(beautiful.icon_control_close, beautiful.foreground),
					halign = "center",
					valign = "center",
					resize = true
				}
